...
public class MotoristaAdapter extends ArrayAdapter<Motorista> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nascMot = (TextView) rowView.findViewById(R.id.txtNascMot);
        TextView rgMot = (TextView) rowView.findViewById(R.id.txtRgMot);
        TextView sexoMot = (TextView) rowView.findViewById(R.id.txtSexoMot);

        nomeMotorista.setText(elementos.get(position).getMotororistaNome());
        ...
        nascMot.setText(elementos.get(position).getMotoristaNasc());
        sexoMot.setText(elementos.get(position).getMotoristaSexo());
        rgMot.setText(Integer.toString(elementos.get(position).getMotoristaRg()));
