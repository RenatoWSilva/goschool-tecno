...
public class EstudanteEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText sexo = (EditText) findViewById(R.id.edsexoest);
        final EditText rg = (EditText) findViewById(R.id.edrgest);
        final EditText nascimento = (EditText) findViewById(R.id.ednascest);
        ...
        call.enqueue(new Callback<Estudante>() {
            ...
            public void onResponse(Call<Estudante> call, Response<Estudante> response) {
                ...
                matricula.setText(estudante.getEstudanteMatricula());
                sexo.setText(estudante.getEstudanteSexo());
                rg.setText(String.valueOf(estudante.getEstudanteRg()));
                nascimento.setText(estudante.getEstudanteNasc());
            }
        ...
        alterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                estudante.setEstudanteMatricula(matricula.getText().toString());
                estudante.setEstudanteSexo(sexo.getText().toString());
                estudante.setEstudanteRg(Integer.parseInt(rg.getText().toString()));
                estudante.setEstudanteNasc(nascimento.getText().toString());
